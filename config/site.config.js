...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'eiyooooo@duub.onmicrosoft.com',
  ...
  title: "duub's high school memory",
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/eiyooooo/onedrive-vercel-index',
    },
  ],
